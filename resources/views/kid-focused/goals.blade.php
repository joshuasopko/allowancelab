...
@section('content')
    ...
    <style>
        ...
        .parent-goals-card-grid { display: grid; grid-template-columns: repeat(4, 1fr); gap: 20px; align-items: stretch; }
        @media (max-width: 1100px) { .parent-goals-card-grid { grid-template-columns: repeat(3, 1fr); } }
        ...
        .kid-goal-card-redeemed-info { display: flex; align-items: baseline; gap: 4px; margin-top: 4px; }
    </style>
