                ...
                <table width="600" cellpadding="0" cellspacing="0" style="background-color: white; border-radius: 12px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                    ...
                    <tr>
                        <td style="padding: 40px;">
                            <h2 style="margin: 0 0 20px 0; color: #1f2937; font-size: 24px;">Hi {{ $kid->name }}! 👋</h2>
                            
                            <p style="margin: 0 0 20px 0; color: #4b5563; font-size: 16px; line-height: 1.6;">
                                {{ $parent->name }} has changed your username.
                            </p>
                            
                            <div style="padding: 20px; background: #f0f9ff; border-left: 4px solid #3b82f6; border-radius: 4px; margin: 20px 0;">
                                <p style="margin: 0 0 10px 0; color: #1e40af; font-size: 14px;"><strong>Old Username:</strong> {{ $oldUsername }}</p>
                                <p style="margin: 0; color: #1e40af; font-size: 14px;"><strong>New Username:</strong> {{ $newUsername }}</p>
                            </div>
                            
                            <p style="margin: 20px 0 0 0; color: #4b5563; font-size: 16px; line-height: 1.6;">
                                You can now log in to AllowanceLab using your new username.
                            </p>
                        </td>
                    </tr>
