                ...
                <table width="600" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td
                            ...
                            <p style="margin: 10px 0 0 0; color: rgba(255,255,255,0.9); font-size: 16px;">Family
                                Invitation</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 40px;">
                            <h2 style="margin: 0 0 20px 0; color: #1f2937; font-size: 24px;">Hi {{ $invitedName }}! 👋
                            </h2>

                            <p style="margin: 0 0 20px 0; color: #4b5563; font-size: 16px; line-height: 1.6;">
                                <strong>{{ $inviterName }}</strong> has invited you to join their family on AllowanceLab
                                as a <strong>Parent Account</strong>.
                            </p>

                            <p style="margin: 0 0 20px 0; color: #4b5563; font-size: 16px; line-height: 1.6;">
                                As a parent account, you'll have full access to:
                            </p>

                            <ul style="margin: 0 0 30px 0; color: #4b5563; font-size: 16px; line-height: 1.8;">
                                <li>View and manage all kids' accounts</li>
                                <li>Record deposits and spending</li>
                                <li>Adjust points and allowances</li>
                                <li>Track transaction history</li>
                                <li>Manage kids' settings</li>
                            </ul>
